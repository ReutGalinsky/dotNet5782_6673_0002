...
{
    [Serializable]
    public class ExistingException : Exception//exception for item that already exist in the data base
    {
    ...
    public class NotExistingException : Exception//exception for item that not exist in the data base
    {
